...
source bin/citrea/tests/proving-stats/.venv/bin/activate
python bin/citrea/tests/proving-stats/get-proving-stats.py batch-prover.log $TEST_DIR/results/$OUT_FILE_NAME
