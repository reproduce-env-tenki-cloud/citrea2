...
Mac:
```sh
RISC0_DEV_MODE=1 ./citrea-v0.7.0-rc.2-osx-arm64 --network testnet --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```
...
JSON_LOGS=1 \
RISC0_DEV_MODE=1  \
./citrea-v0.7.0-rc.2-osx-arm64 --network testnet --da-layer bitcoin --genesis-paths ./genesis
```

Linux:
```sh
RISC0_DEV_MODE=1 ./citrea-v0.7.0-rc.2-linux-amd64 --network testnet --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```
...
JSON_LOGS=1 \
RISC0_DEV_MODE=1  \
./citrea-v0.7.0-rc.2-linux-amd64 --network testnet --da-layer bitcoin --genesis-paths ./genesis
```
