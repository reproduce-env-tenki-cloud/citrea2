...
Mac:
```sh
./citrea-v0.7.4-rc.1-osx-arm64 --network testnet --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```
...
RUST_LOG=info \
JSON_LOGS=1 \
./citrea-v0.7.4-rc.1-osx-arm64 --network testnet --da-layer bitcoin --genesis-paths ./genesis
```

Linux:
```sh
./citrea-v0.7.4-rc.1-linux-amd64 --network testnet --da-layer bitcoin --rollup-config-path ./rollup_config.toml --genesis-paths ./genesis
```
...
RUST_LOG=info \
JSON_LOGS=1 \
./citrea-v0.7.4-rc.1-linux-amd64 --network testnet --da-layer bitcoin --genesis-paths ./genesis
```
